...
async def gen_session(
    ...
    try:
        txt = "ʜᴇʀᴇ ɪs ʏᴏᴜʀ {0} sᴛʀɪɴɢ sᴇssɪᴏɴ\n\n<code>{1}</code>\n\nᴀ sᴛʀɪɴɢ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ ʙʏ <a href={2}>Ꮥʜꫝʟɪɴɪ</a>\n☠ <b>ɴᴏᴛᴇ :</b> ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ."
        if telethon:
            ...
            await client(JoinChannelRequest("@MUSIC_WORLD_SH"))
        else:
            ...
            await client.join_chat("MUSIC_WORLD_SH")
    except KeyError:
        pass
    try:
